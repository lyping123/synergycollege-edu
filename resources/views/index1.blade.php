      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="assets/images/section2.jpg" alt="" class="main-image">
            <img src="assets/images/section2a.jpg" alt="" class="hover-image">
          </div>
        </div>
        <div class="col-lg-6">
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          ...
          <div class="modal-body">
              <img id="modalImage" src="" class="img-fluid" alt="Modal Image" style="border-radius: 5px;">
          </div>
      </div>
  </div>
</div>
      ...
      <div class="row">
        <div class="col-6 col-md-4 col-lg-3">
          <div class="item first-item">
            <img src="assets/images/school.png" alt="" style="width: 100px;">
              ...
              <h4 style="font-size: 18px; margin-top:15px;">HIGHER VOCATIONAL EDUCATION PROVIDER</h4>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="item first-item">
            ...
            <h4 style="font-size: 18px; margin-top:15px;">PROVIDE THOUSANDS HANDS-ON PRACTICAL LEARN ALL USEFUL THEORY THROUGH PRACTICAL</h4>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="item first-item">
            ...
            <h4 style="font-size: 18px; margin-top:15px;">INDUSTRIAL PLACEMENT/ INTERNSHIP/ INDUSTRIAL TRAINING</h4>
          </div>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <div class="item first-item">
            ...
            <h4 style="font-size: 18px; margin-top:15px;">MULTIPLE QUALIFICATIOBS IN ONE PROGRAM</h4>
          </div>
        </div>
